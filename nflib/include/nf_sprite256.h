...
extern "C" {
	...
	} NF_TYPE_NF_SPRPALSLOT_INFO;
	extern NF_TYPE_NF_SPRPALSLOT_INFO NF_SPRPALSLOT[2][16];
	...
	typedef struct {
		...
		u8 deleted;			// Numero de bloques borrados
